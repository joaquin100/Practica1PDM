  ...
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.POSTRES) {
      return <ProductDessert>[
        ProductDessert(
          productTitle: "Flan",
          productDescription: "Esquisito flan de vainilla.",
          productImage:
              "https://cdn.kiwilimon.com/recetaimagen/16220/10529.jpg",
        ...
        ProductDessert(
          ...
          productDescription:
              "Pastel de chocolate de carlos V muy espongoso y delicioso.",
          productImage:
        ...
        ProductDessert(
          productTitle: "Dona de Krispy Kream",
          productDescription: "Dona clásica de Krispy kream glaseada.",
          productImage:
        ...
        ProductDessert(
          productTitle: "Novia",
          productDescription:
              "Pan de Dulce Mexicano llamado novia, te hará pasar buenos momentos, no como tu ex.",
          productImage:
              "https://64.media.tumblr.com/5eff5a0aecbcee8372f8e1ecbe2a80e3/tumblr_mjwa2rGmUW1qgdewxo1_r2_640.jpg",
          productSize: ProductSize.M,
          productAmount: 0,
        ),
        ProductDessert(
          productTitle: "Budín de pan integral",
          productDescription:
              "Postre fit hecho a base de pan integral cómo lo recomineda Barbara de Regil",
          productImage: "https://i.ytimg.com/vi/J4PGH7BB3tA/hqdefault.jpg",
          productSize: ProductSize.M,
          productAmount: 0,
        ),
      ];
